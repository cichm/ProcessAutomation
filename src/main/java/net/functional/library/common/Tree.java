...
public abstract class Tree<A extends Comparable<A>> {
  ...
  protected Tree<A> redden(Tree<A> t) {
    if (t.isEmpty()) throw new IllegalStateException("Dla pustego drzewa nie można użyć redden");
  ...
  private static abstract class Empty<A extends Comparable<A>> extends Tree<A> {
    ...
    protected Tree<A> removeMax() {
      throw new IllegalStateException("removeMax wywołane dla Empty");
    }

    @Override
    public A max() {
      throw new IllegalStateException("max wywołane dla Empty");
    }

    @Override
    public A min() {
      throw new IllegalStateException("min wywołane dla Empty");
    }
    ...
    @Override
    A value() {
      throw new IllegalStateException("value wywołane dla Empty");
    }
  ...
  private static class DoubleBlack extends Color {
    ...
    @Override
    Color blacker() {
      throw new IllegalStateException("Nie można użyć blacker dla DoubleBlack");
    }
  ...
  private static class NegativeBlack extends Color {
    ...
    @Override
    Color redder() {
      throw new IllegalStateException("Nie można użyć redder dla NegativeBlack");
    }
